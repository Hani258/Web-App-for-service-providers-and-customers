...
<!-- 									<h4 class="clrchg">Kitchen appliences</h4> --> 
<!-- 								</div> --> 
<!-- 							</div> --> 
<!-- 						</a> --> 
<!-- 					</div>	 --> 
						...
						<a href="categories.html#parentVerticalTab11">
							<div class="focus-border">
								<div class="focus-layout">
									...
									<h4 class="clrchg">Clock and Watch</h4>
								</div>
							</div>
						</a>
					</div>
						...
						<a href="categories.html#parentVerticalTab12">
							<div class="focus-border">
								<div class="focus-layout">
									...
									<h4 class="clrchg">Kitchen Stoup</h4>
								</div>
							</div>
						</a>
					</div>
						...
						<a href="categories.html#parentVerticalTab10">
							<div class="focus-border">
								<div class="focus-layout">
									...
									<h4 class="clrchg">Other Services</h4>
								</div>
							</div>
						</a>
					</div>
			...
			<div class="mobile-app">
				<div class="container">
					...
					<div class="col-md-7 app-right">
						<h3>Mend Your Thing App Is the <span>Easiest</span> way for Find Service Provider Online to Repair Things</h3>
						<p>By This App Custumer Get Many Choices For Service Provider And Repair Their Items At Low Price With Saving Their Time, And Shopkeepers Also Get More Custumers Easily</p>
